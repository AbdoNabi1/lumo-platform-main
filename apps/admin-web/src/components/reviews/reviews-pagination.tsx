...
/**
 * Cursor-only pagination, same client-side back-stack technique as `OrdersPagination` (see its
 * own doc comment): every `pageInfo` in this app is `{ hasNextPage, endCursor }` only
