...
/**
 * Cursor-only pagination, same client-side back-stack technique as `FeatureFlagsPagination`/
 * `NotificationsPagination`: every `pageInfo` in this app is `{ hasNextPage, endCursor }` only
