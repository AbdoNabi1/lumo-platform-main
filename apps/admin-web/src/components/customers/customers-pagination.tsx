...
/**
 * Cursor-only pagination — same technique as `OrdersPagination` (the backend `GET /customers` has
 * no `before`/offset support, only a forward `after` cursor). "Previous" is a client-side back-stack
 * of prior cursors kept in the `stack` URL param.
 */
