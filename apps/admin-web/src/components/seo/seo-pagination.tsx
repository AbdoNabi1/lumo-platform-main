...
/**
 * Cursor-only pagination shared by all four `/seo/*` list screens — same technique as
 * `PagesPagination`/`ContentPagination`/`OrdersPagination`, factored into one component since all
 * four SEO lists share the identical `{first, after}` cursor shape and label set (`t.seoNav`).
 */
