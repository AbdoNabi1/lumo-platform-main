...
/**
 * Cursor-only pagination, same client-side back-stack technique as `NotificationsPagination`/
 * `ReviewsPagination`: every `pageInfo` in this app is `{ hasNextPage, endCursor }` only
 ...
 */
export function FeatureFlagsPagination({
  hasNextPage,
  endCursor,
  t,
}: {
