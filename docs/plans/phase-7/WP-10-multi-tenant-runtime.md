...
| --------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `apps/admin/src/composition.ts:650`, `apps/admin/src/infrastructure/cross-context/promotion-validation.adapter.ts:55,75` (`PromotionValidationAdapter`)   | **A** — checkout                       | Implements checkout's own `PromotionValidationPort` (`services/checkout/src/application/ports.ts`); captures `tenantId` at construction per its own doc comment, pending checkout's own T10.3 conversion which would widen that port to carry `tenantId` per call.                                                                                                                                                                                                                                                                                                                                                               |
...
| `apps/admin/src/composition.ts:644`, `apps/admin/src/infrastructure/cross-context/pricing-validation.adapter.ts:28,40` (`PricingValidationAdapter`)       | **A** — checkout                       | Implements checkout's `PricingValidationPort`, which carries no tenant; pricing's `PriceRepository.findPublishedByProduct` now needs one per call, so the adapter captures it at construction and fails closed without one, pending checkout's own conversion (added 2026-09-18, pricing).                                                                                                                                                                                                                                                                                                                                       |
| `apps/admin/src/composition.ts:606`, `apps/admin/src/infrastructure/cross-context/orders-notification.adapter.ts:43,58` (`OrdersNotificationAdapter`)     | **A** — orders                         | Implements orders' `NotificationPort`, which carries no tenant; notifications' controller now needs one per call, so the adapter captures it at construction and throws without one, pending orders' own conversion (added 2026-09-18, notifications).                                                                                                                                                                                                                                                                                                                                                                           |
| `apps/admin/src/composition.ts:681`, `apps/admin/src/infrastructure/cross-context/payments-notification.adapter.ts:50,65` (`PaymentsNotificationAdapter`) | **A** — payments                       | Same shape as `OrdersNotificationAdapter`, for payments' `NotificationPort`, pending payments' own conversion (added 2026-09-18, notifications).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
